...
<div class="section clearfix">
	<form class="log-reg" id="saveForm">
		...
		<div class="in-group clearfix">
			<label>验证码</label>
			<input name="yzm" id="yzm"  type="text"/>
				<p id="yzmError"></p>
			<a href="javascript:void();" id="send" onclick="sendSmsCode('${request.contextPath}/cus/info/sendMessage')">获取
			</a>
		...
		<a class="btn" href="javascript:void(0);" onclick="registerFun1('${request.contextPath}/cus/info/usersave','${request.contextPath}/index')">注册</a>
	</form>
